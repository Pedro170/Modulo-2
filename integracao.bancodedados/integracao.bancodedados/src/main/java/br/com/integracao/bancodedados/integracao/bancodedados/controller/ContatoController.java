package br.com.integracao.bancodedados.integracao.bancodedados.controller;
...
public class ContatoController {
	...
	public ResponseEntity<Contato> getById(@PathVariable Long id) {
		return contatoRepository.findById(id).map(resp -> ResponseEntity.ok(resp)).orElse(ResponseEntity.badRequest().build());
	}
